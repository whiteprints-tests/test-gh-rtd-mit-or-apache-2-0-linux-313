...
The project is hosted on [https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-linux-313.git](https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-linux-313.git).
